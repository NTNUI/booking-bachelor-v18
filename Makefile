...
testenv:
	rm -f mydatabase
	make migrate
	docker-compose run web python manage.py loaddata users.json groups.json locations.json memberships.json boards.json invitations.json forms.json mainboard.json hs-memberships.json
